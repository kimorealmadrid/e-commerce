...
?>
		...
		<div id="logo">
			<h1><a href="accueil.php" title="Tout est facile chez nous.">Shop En Ligne</a></h1>
			<p id="slogan">tout est facile chez nous.</p>
		</div>
				
		<ul id="tablist">
			<li><a href="Accueil.php" accesskey="n"><span class="key"></span>Accueil</a></li>
		...
		<div id="left">
			<div class="subheader">
				<p>Vous êtes sur > <a href="Categories.php">Catégories</a> </p>
			</div>
			<div class="left_articles">
				<h2>Nos catégories :</h2><br>
				<div class="thirds"><br><br>
				<a href=#><img src=images/pcb.jpg width=180 height=100 ></a>
				<center><a href=#>Ordinateurs bureautiques</a></center>
				</div>  
				<a align=right><div class="cat"><br><br>
				<a href=#><img src=images/pcp.jpg width=180 height=100 ></a>
				<center><a href=#>Ordinateurs portables</a></center>
				</div></a>
				<div class="thirds"><br><br>
				<a href=#><img src=images/port.jpg width=180 height=100 ></a><br>
				<center><a href=#>Téléphones portables</a></center>
				</div><br>
				
				<div class="cat"><br><br><br>
				<a href=#><img src=images/tab.jpg width=180 height=100 ></a><br>
				<center><a href=#>Tablettes</a></center>
				</div><br>
					<div class="thirds"><br><br><br>
				<a href=#><img src=images/tv.jpg width=180 height=100 ></a><br>
				<center><a href=#>Tv</a></center>
				</div><br>
					<div class="cat"><br><br>
				<a href=#><img src=images/per.jpg width=180 height=100 ></a>
				<center><a href=#>Périphériques</a></center>
				</div><br>
			</div>
			<br><br><br><br><br>
			<div class="thirds">
		...
		<div id="right"></br>
			<div class="right_articles">
				<p><img src="images/image.gif" alt="Image" title="Image" class="image" /><b>Bienvenue</b><br/><a href="#"></a> <a href="#"></a>Soyez la bienvenue sur  <strong>Shop en Ligne</strong> .</br>Ici vous trouvez tous ce que vous cherchez avec des prix fous .</br></br></p>
			</div>
			</br>
			<div class="right_articles">
				<p><img src="images/image.gif" alt="Image" title="Image" class="image" /><b>Produits en solde</b><br /><a href="#"></a><a href="#"></a></br></br></br></p>
