...
?>
		...
		<div id="right"></br>
			<div class="right_articles">
				<p><img src="images/wl.jpg " alt="Image" width=60px height=60px title="Image" class="image" /><b>Bienvenue</b><br/><a href="#"></a> <a href="#"></a>Soyez la bienvenue sur  <strong>Shop en Ligne</strong> .</br>Ici vous trouvez tous ce que vous cherchez avec des prix fous .</br></br></p>
			</div>
			</br>
			<div class="right_articles">
