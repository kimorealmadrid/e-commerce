...
if(isset($_POST["Supprimer"]))
{
	...
	$efface_donnees = mysql_query("DELETE FROM PRODUITS WHERE id = $id");
	...
	if (!$efface_donnees) {
		...
		echo '<div class="cadre"><p>Le produit à &eacute;t&eacute; supprim&eacute; avec succès. <a href=inde.php>Retour à l\'administration.</a></p></div>';
	}
...
if($masquer_formulaire == 0) { 
	...
	<form action="supprimer-produit.php?id=<?php echo $id;?>" method="post">
	<p><input name="Supprimer" value="Supprimer le produit N°<?php echo $id;?>"type="submit" /></p>
	</form>
